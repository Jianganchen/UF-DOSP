...
loop(Num, List, NumOfZeros, Names) when Num > 0 ->
  ...
  if
    SubStringFront == MultipleZeros ->
      io:fwrite("Yes!!\n"),
      {ok, Fd} = file:open("C:/Users/13522/IdeaProjects/ProjBitcoin/src/Keys.txt", [append]),
...
%This printTime function here we learned from https://github.com/zldxbx/COP5615P1/blob/main/master.erl.
printTime(Fd) ->
